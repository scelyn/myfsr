    ...
    <div class="space-y-6" x-data="{ showDeleteModal: false, deleteUrl: '', deleteName: '' }">
                            ...
                            <tr class="hover:bg-theme-bg/60 transition-colors group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 bg-[#06141B]/10 rounded-xl flex items-center justify-center text-[#06141B] text-sm font-black shrink-0">
                                            {{ strtoupper(substr($customer->nama_toko, 0, 1)) }}
                                        </div>
                                        <div>
                                            <div class="font-semibold text-[#06141B]">{{ $customer->nama_toko }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $customer->no_whatsapp) }}" target="_blank"
                                       class="flex items-center gap-1.5 text-sm text-theme-successText hover:text-theme-successText font-medium">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="{{ route('customers.show', $customer) }}"
                                           class="p-2 text-theme-text2 hover:text-theme-successText hover:bg-theme-success/20 rounded-lg transition-all" title="Detail">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <a href="{{ route('customers.create') }}" class="text-sm font-semibold text-theme-successText hover:underline">+ Tambah customer baru</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="relative bg-theme-card rounded-2xl shadow-2xl p-8 max-w-sm w-full"
                ...
                <h3 class="text-lg font-bold text-center text-[#06141B] mb-1">Hapus Customer?</h3>
