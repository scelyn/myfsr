                ...
                <div>
                    ...
                    <div class="space-y-1.5 mb-5">
                        ...
                        <input type="text" name="nama_barang" value="{{ old('nama_barang', $product->nama_barang) }}"
                               class="w-full px-4 py-3 bg-theme-bg border {{ $errors->has('nama_barang') ? 'border-red-400' : 'border-theme-border' }} rounded-xl text-sm font-medium text-white focus:ring-2 focus:ring-emerald-500/20 focus:border-theme-success outline-none transition-all"
                               autofocus>
